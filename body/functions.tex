...
\begin{columns}
    ...
    \begin{center}
        ...
        \only<1>{\includegraphics[height=2.5in]{stat/persistence-one-landscape}}%
        \only<2>{\includegraphics[height=2.5in]{stat/persistence-all-landscapes}}%
        \only<3>{\includegraphics[height=2.5in]{stat/persistence2-labeled}}%
        \only<4->{\includegraphics[height=2.5in]{stat/persistence-silhouette}}%
    \end{center}
    \column{.45\textwidth}
